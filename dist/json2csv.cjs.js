...
var validDecimalFormat = [currencyFormat, priceFormat];
...
function () {
  ...
  _createClass(JSON2CSVBase, [{
      ...
      return fields.map(function (fieldInfo) {
        ...
        if (_typeof(fieldInfo) === 'object') {
          ...
          if (typeof fieldInfo.value === 'string') {
            var decimalFormat = fieldInfo.decimalFormat && validDecimalFormat.includes(fieldInfo.decimalFormat) && fieldInfo.decimalFormat;
            return {
    ...
    key: "processValue",
    value: function processValue(value, fieldInfo) {
      var stringify = fieldInfo.stringify,
          decimalFormat = fieldInfo.decimalFormat;
